...
def get_user() -> Union[Dict, None]:
    """Get user information based on the 'login_as' query parameter"""
...
@app.before_request
def before_request():
    """Before each request, set the 'g.user' attribute to the current user"""
...
def get_timezone():
    """Get the preferred timezone for the current request"""
